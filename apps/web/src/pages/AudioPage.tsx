...
const darkNightSpotlight = {
  ...
  tracks: [
    ...
    {
      id: "wQwOin2dMY8",
      title: "Grace a Dieu version longue",
      label: "Lyrics"
    },
    {
      id: "d3c24QyUWeg",
    ...
    {
      id: "P3bw1D8-Nfk",
      title: "L'eveil spirituel nous separe des gens qu'on aime",
      label: "Reflexion"
    },
    {
      id: "rI6YNiRbZCw",
      title: "Justice pour le diable",
      label: "Short"
    },
    {
      id: "G-hV_M783tg",
      title: "J'veux pas aller au paradis",
      label: "Morceau"
    }
  ]
};
          ...
          <div className="grid gap-0 lg:grid-cols-[0.95fr_1.25fr]">
            ...
            <div className="border-t border-white/10 bg-black/22 p-3 lg:border-l lg:border-t-0">
              <YouTubeEmbed
                ...
                videoUrl={`https://www.youtube.com/watch?v=${selectedDarkNightVideoId}`}
