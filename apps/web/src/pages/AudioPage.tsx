  ...
  return (
    <>
      ...
      <section className="px-4 py-6 pb-24">
        ...
        >
          <h2 className="text-xl font-semibold text-white mb-4">Audio en construction</h2>
          <p className="text-sand/72">
            La fonctionnalité audio est en cours de développement. Revenez bientôt pour découvrir les pistes disponibles.
          </p>
        </motion.section>
      </section>
    </>
