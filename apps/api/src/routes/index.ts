...
// import feedRouter from "./feedRoutes.js"; // Moved to modular routes
...
// import { contentRouter } from "./contentRoutes.js"; // Moved to modular routes
...
import mediaUploadRouter from "./mediaUploadRoutes.js";
import debateThreadRouter from "./debateThreadRoutes.js";
import creatorRouter from "./creatorRoutes.js";
import creatorAIRouter from "./creatorAIRoutes.js";

export const apiRouter = Router();

// apiRouter.use("/auth", authRouter); // Moved to modular routes
apiRouter.use("/admin", adminRouter);
apiRouter.use("/admin/keywords", keywordAdminRouter);
// apiRouter.use("/feed", feedRouter); // Moved to modular routes
...
// apiRouter.use("/content", contentRouter); // Moved to modular routes
...
apiRouter.use("/upload", mediaUploadRouter);
apiRouter.use("/debates", debateThreadRouter);
apiRouter.use("/api", creatorRouter);
apiRouter.use("/api/ai", creatorAIRouter);
